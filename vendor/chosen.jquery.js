...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      regex = new RegExp(searchText.split('').join('\\w*').replace(/\W/, ""), 'i');
    ...
    Chosen.prototype.no_results = function(terms, selected) {
      var no_results_html;
      no_results_html = $('<li class="no-results">' + this.results_none_found + ' "' + terms + '"</li>');
      var _this = this;
      var create_option_html = $('<p>').addClass("create-option").append($("<a>").html(this.create_option_text + " '" + terms + "'").click(function(evt) {
        return _this.select_create_option($.trim(_this.search_field.val()));
      }));
      this.search_results.append(no_results_html).append(this.create_option ? create_option_html : "");
    };
